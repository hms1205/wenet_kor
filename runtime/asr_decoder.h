...
class AsrDecoder {
 public:
  ...
  DecodeState Decode(bool log, bool block = true);
  void Rescoring(bool log);
  void Reset();
 ...
 private:
  DecodeState AdvanceDecoding(bool log, bool block = true);
  void AttentionRescoring(bool log);

  void UpdateResult(bool log, bool finish = false);
